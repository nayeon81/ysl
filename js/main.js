$(document).ready(function(){
    ...
    //.tab영역의 첫번쨰 설명 부분만 currentDes에 저장
    var currentDes=$('.tab_des ul li:first');
    //oldDes 변수 선언
    var oldDes='';
    //desMove함수 선언, btnNum은 클릭한 a태그의 인덱스 번호를 전달받는 매개변수
    function desMove(btnNum){
        //currentDes의 값을 oldDes에 저장
        oldDes=currentDes;
        //클릭한 a태그의 인덱스 번호에 해당하는 설명 부분을 currentDes변수에 저장
        ...
        oldDes.stop().animate({
            ...
            //oldDes값이 위로 사라진 후에 다시 아래쪽으로 이동
        },500,function(){
            oldDes.css({
                opacity:0, top:700
            });
    ...
    //outerWidth()속성은 margin을 포함한 가로길이 인식하느 메서드
    ...
    $('.site_menu nav > ul > li > a').hover(function(){
        ...
        //.site_menu nav ul li에서 마우스아웃했을 때 
